namespace eval ::optrace {
  variable script "C:/Modelsim_projects/Project/hw/hw.runs/impl_1/top.tcl"
...
OPTRACE "set parameters" START { }
  set_property webtalk.parent_dir C:/Modelsim_projects/Project/hw/hw.cache/wt [current_project]
  set_property parent.project_path C:/Modelsim_projects/Project/hw/hw.xpr [current_project]
  set_property ip_repo_paths D:/WorkBORI/keyboard/Nexys-A7/hw/repo [current_project]
  update_ip_catalog
  set_property ip_output_repo C:/Modelsim_projects/Project/hw/hw.cache/ip [current_project]
  set_property ip_cache_permissions {read write} [current_project]
OPTRACE "set parameters" END { }
OPTRACE "add files" START { }
  add_files -quiet C:/Modelsim_projects/Project/hw/hw.runs/synth_1/top.dcp
OPTRACE "read constraints: implementation" START { }
  read_xdc C:/Modelsim_projects/Project/hw/hw.srcs/constrs_1/imports/constraints/Nexys-A7-100T-Master.xdc
